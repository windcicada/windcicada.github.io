...
* **牛顿流体的动量守恒方程 (N-S方程)**
  ...
  $\dfrac{\partial\rho u_i}{\partial t}+\dfrac{\partial\rho u_i u_j}{\partial x_j}=-\dfrac{\partial P}{\partial x_i}+\dfrac{\partial \sigma_{ij}}{\partial x_i}+F_i$
...
**压力耦合方程组的半隐式方法(Semi-ImPlicit Method for Pressure Linked Equations)**
